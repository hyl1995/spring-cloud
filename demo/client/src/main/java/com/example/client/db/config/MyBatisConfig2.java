package com.example.client.db.config;

import com.atomikos.jdbc.AtomikosDataSourceBean;
import com.example.client.db.DBConfig2;
...
@MapperScan(basePackages = "com.example.client.mapper.test2", sqlSessionTemplateRef = "sqlSessionTemplate2")
